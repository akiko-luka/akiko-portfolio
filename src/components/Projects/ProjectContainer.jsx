...
const ProjectContainer = () => {
  return (
    <>
      <section
        id="projects"
        className="scroll flex flex-col items-center justify-center border-b-[3px] border-gray-main p-8 pb-20"
      >
        ...
        <div className="m-auto flex h-full flex-wrap justify-center gap-4 p-0">
          <ProjectCard
            ...
            title={"akpica blog"}
            description={"This blog provides web development resources, offering tools and knowledge for developers of all levels to succeed."}
          ...
          <ProjectCard
            ...
            description={"This eCommerce platform is designed to provide users with a range of features that make browsing, selecting, and purchasing products."}
          ...
          <ProjectCard
            ...
            title={"the projects"}
            description={"JavaScript Projects for mastering the art of web development through hands-on practice with Vanilla JavaScript."}
          ...
          <ProjectCard
            ...
            title={"first project"}
            description={"This project showcases my basic HTML and CSS skills, marking a key milestone in my web development journey."}
          ...
          <ProjectCard
            ...
            description={"A turn-based console game built using Node.js. Offering a Dragon Ball Z-themed gaming experience."}
