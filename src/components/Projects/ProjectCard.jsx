...
const ProjectCard = ({
  ...
  return (
    <>
      <article>
        <div
          className={`m-[10px] h-[430px] w-[300px] rounded overflow-hidden border-black-main ${darkMode ? "border border-white-main bg-gray-dark shadow-box-shadow-dark" : "border-0 bg-gray-main shadow-box-shadow"}`}
        >
