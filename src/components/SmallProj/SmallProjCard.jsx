      ...
      <article>
        <a href={spUrl} target="_blank">
          <img
            src={spImage}
            alt={altTitle}
            className={`mb-5 h-[180px] w-[280px] object-cover object-center transition-all duration-300 ease-out md:hover:scale-110 ${darkMode ? "shadow-box-shadow-dark" : "shadow-box-shadow"}`}
          />
